...
(function () {
  ...
  const dragons = [
    ...
    { name: 'Bonestormer', cls: 'Mystery', size: '≈ 10–14 m long (est.)', weight: '≈ 2,500–4,000 kg (est.)', behaviour: 'Appears in the extended franchise outside the main films/series; specifics haven\\\'t been fleshed out much yet.', appears: 'Extended franchise (games, comics & spin-offs)' },
    ...
    { name: 'Green Death', cls: 'Boulder (Queen)', size: '≈ 90–120 m long (est., hive-queen scale)', weight: '≈ 45,000–70,000 kg (est.)', behaviour: 'A giant hive-queen dragon in the same mold as the Red Death, appearing in the wider franchise outside the first film.', appears: 'Extended franchise (comics/games)' },
