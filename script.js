...
(function () {
  ...
  const dragons = [
    ...
    { name: 'Bewilderbeast', cls: 'Tidal (Alpha)', size: '≈ 158.5 m long · 45.7 m wingspan', weight: '≈ 90,700 kg (est., official mass unconfirmed)', behaviour: 'A calm, commanding alpha that controls and protects an entire dragon nest using ice breath.', appears: 'HTTYD 2 (2014)' },
    ...
    { name: 'Cavern Crasher', cls: 'Boulder', size: '≈ 6–9 m long (est.)', weight: '≈ 2,500–4,000 kg (est.)', behaviour: 'Appears in the extended franchise outside the main films/series; specifics haven\'t been fleshed out much yet.', appears: 'Extended franchise (games, comics & spin-offs)' },
    { name: 'Changewing', cls: 'Mystery', size: '≈ 6–8 m long (est.)', weight: '≈ 350–600 kg (est.)', behaviour: 'Shy unless protecting its young, can camouflage and spits corrosive acid.', appears: 'Riders of Berk' },
    ...
    { name: 'Crimson Slasher', cls: 'Sharp', size: '≈ 5–7 m long (est.)', weight: '≈ 300–600 kg (est.)', behaviour: 'Quick and aggressive, with blade-like claws built for slashing through dense brush.', appears: 'Race to the Edge' },
    ...
    { name: 'Deathgripper', cls: 'Strike', size: '≈ 9–12 m long (est.)', weight: '≈ 1,800–3,000 kg (est.)', behaviour: 'Highly aggressive and territorial, with a venomous stinger and crushing claws; very difficult to tame.', appears: 'HTTYD: The Hidden World (2019)' },
    { name: 'Devilish Dervish', cls: 'Mystery', size: '≈ 4–6 m long (est.)', weight: '≈ 200–450 kg (est.)', behaviour: 'Erratic, spinning flight pattern makes it hard to predict or pin down.', appears: 'Race to the Edge' },
    ...
    { name: 'Dramillion', cls: 'Tracker', size: '≈ 4–6 m long, slender build (est.)', weight: '≈ 150–350 kg (est.)', behaviour: 'Playful and mischievous, with unusually nimble limbs for climbing and grabbing.', appears: 'Race to the Edge' },
    ...
    { name: 'Eruptodon', cls: 'Boulder', size: '≈ 10–14 m long (est.)', weight: '≈ 5,000–8,000 kg (est.)', behaviour: 'A gentle giant that eats lava rock and sneezes fireballs when it has a cold.', appears: 'Race to the Edge' },
    ...
    { name: 'Foreverwing', cls: 'Tracker', size: '≈ 15–35 m long, grows larger with age (est.)', weight: '≈ 8,000–18,000 kg (est.)', behaviour: 'An ancient, long-lived species said to grow larger the longer it lives; generally reclusive.', appears: 'Race to the Edge' },
    ...
    { name: 'Grapple Grounder', cls: 'Mystery', size: '≈ 5–7 m long (est.)', weight: '≈ 350–650 kg (est.)', behaviour: 'Cunning and opportunistic, uses a grappling-hook tail to snare prey.', appears: 'Race to the Edge' },
    ...
    { name: 'Green Death', cls: 'Stoker (Queen)', size: '≈ 90–120 m long (est., hive-queen scale)', weight: '≈ 45,000–70,000 kg (est.)', behaviour: 'A giant hive-queen dragon in the same mold as the Red Death, appearing in the wider franchise outside the first film.', appears: 'Extended franchise (comics/games)' },
    { name: 'Grim Gnasher', cls: 'Stoker', size: '≈ 2–3 m long (est.)', weight: '≈ 40–90 kg (est.)', behaviour: 'Quick-tempered and snappy despite its small size, fiercely defends its space.', appears: 'Race to the Edge' },
    { name: 'Groncicle', cls: 'Boulder', size: '≈ 4–5 m long, thickset (est.)', weight: '≈ 2,200–2,800 kg (est.)', behaviour: 'A calm, slow-moving cousin of the Gronckle that breathes ice instead of fire.', appears: 'Race to the Edge' },
    { name: 'Gronckle', cls: 'Boulder', size: '4.3 m long · 5.5 m wingspan', weight: '≈ 2,596 kg', behaviour: 'Lazy and easygoing despite eating rocks; surprisingly strong fliers once moving.', appears: 'How to Train Your Dragon (2010)' },
    { name: 'Hackatoo', cls: 'Sharp', size: '≈ 6–8 m long (est.)', weight: '≈ 600–1,000 kg (est.)', behaviour: 'Restless and easily agitated, with sharp, axe-like head plating.', appears: 'Race to the Edge' },
    ...
    { name: 'Purple Death', cls: 'Stoker (Queen)', size: '≈ 30–160 m long (est.)', weight: '≈ 20,000+ kg (est.)', behaviour: 'Another massive hive-queen species, generally treated as distinct from the Red and Green Death by fans.', appears: 'Extended franchise (comics/games)' },
    ...
    { name: 'Red Death', cls: 'Stoker (Queen)', size: '≈ 121.9 m long · ≈ 30 m tall (official film scale)', weight: 'Unpublished (est. 60,000+ kg given its scale)', behaviour: 'A ruthless hive-queen that commands smaller dragons to feed it; territorial and dangerous.', appears: 'How to Train Your Dragon (2010)' },
    ...
    { name: 'Snifflehide', cls: 'Tracker', size: '≈ 6–9 m long (est.)', weight: '≈ 500–1,000 kg (est.)', behaviour: 'Related to the Snifflehunch, with an equally sharp sense of smell but a thicker, more weather-resistant hide suited to colder climates.', appears: 'Extended franchise (games, comics & spin-offs)' },
    ...
    { name: 'Brooding Boltstamper', cls: 'Strike (Hybrid)', size: '≈ 10–14 m long (est., Skrill × Rumblehorn)', weight: '≈ 3,000–5,000 kg (est.)', behaviour: 'A bred hybrid combining the Skrill\'s storm-channelling instincts with the Rumblehorn\'s armoured bulk; broods and sulks visibly before releasing a lightning-charged burst.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Cyclarion', cls: 'Tracker (Hybrid)', size: '≈ 10–14 m long, bulky bipedal build (est., Typhoomerang × Rumblehorn)', weight: '≈ 3,500–6,000 kg (est.)', behaviour: 'A bred hybrid that struggles to fit in socially with other dragons, sometimes decorating itself with mud and plant matter to win approval; fires exploding, fiery rock projectiles inherited from its Rumblehorn parent.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Deathburple', cls: 'Sharp (Hybrid)', size: '≈ 5–7 m long, stocky and spined (est., Deadly Nadder × Hotburple)', weight: '≈ 1,500–2,200 kg (est.)', behaviour: 'A bred hybrid pairing the Deadly Nadder\'s vain, spine-launching temperament with the Hotburple\'s sleepy, rock-eating bulk.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Deathly Galeslash', cls: 'Sharp (Hybrid)', size: '≈ 10–14 m long, four-winged (est., Deadly Nadder × Stormcutter)', weight: '≈ 800–1,500 kg (est.)', behaviour: 'A bred hybrid combining the Stormcutter\'s four wings and sharp intellect with the Deadly Nadder\'s spine-launching defenses.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Ghastly Zapplejack', cls: 'Mystery (Hybrid)', size: '≈ 15–20 m long, twin-headed (est., Hideous Zippleback × Timberjack)', weight: '≈ 1,200–2,200 kg (est.)', behaviour: 'A bred hybrid with the Hideous Zippleback\'s twin gas-and-spark heads mounted on a long, blade-winged Timberjack body.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Hoarsbrumble', cls: 'Tidal (Hybrid)', size: '≈ 12–18 m long (est., Thunderdrum × Typhoomerang)', weight: '≈ 800–1,500 kg (est.)', behaviour: 'A bred hybrid uniting the Thunderdrum\'s sonic-roar defenses with the Typhoomerang\'s tornado-fuelled fire breath.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Humbanger', cls: 'Boulder (Hybrid)', size: '≈ 8–12 m long, ring-toothed (est., Whispering Death × Snafflefang)', weight: '≈ 2,000–3,500 kg (est.)', behaviour: 'A bred hybrid combining the Whispering Death\'s rotating rings of teeth with the Snafflefang\'s snaggle-fanged snatching bite.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Hushbogle', cls: 'Boulder (Hybrid)', size: '≈ 8–12 m long (est., Whispering Death × Snow Wraith)', weight: '≈ 1,800–3,000 kg (est.)', behaviour: 'A bred hybrid that burrows like a Whispering Death but favours cold, icy terrain inherited from its Snow Wraith parent.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Ridgesnipper', cls: 'Sharp (Hybrid)', size: '≈ 10–15 m long, blade-tailed (est., Razorwhip × Snafflefang)', weight: '≈ 1,200–2,200 kg (est.)', behaviour: 'A bred hybrid pairing the Razorwhip\'s razor-edged tail with the Snafflefang\'s digging claws and snapping bite.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Slumberjack', cls: 'Stoker (Hybrid)', size: '≈ 15–20 m long, thin-bodied (est., Monstrous Nightmare × Timberjack)', weight: '≈ 1,200–2,000 kg (est.)', behaviour: 'A bred hybrid that walks on its wing-claws like a Timberjack while carrying the Monstrous Nightmare\'s hot temper and self-igniting flame.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Thunderbottom', cls: 'Tidal (Hybrid)', size: '≈ 4–6 m long, stocky (est., Thunderdrum × Gronckle)', weight: '≈ 2,000–2,800 kg (est.)', behaviour: 'A bred hybrid with the Gronckle\'s dense, rock-eating build and the Thunderdrum\'s deep sonic roar.', appears: 'Dragons: Titan Uprising (mobile game)' },
    { name: 'Zipplewraith', cls: 'Mystery (Hybrid)', size: '≈ 15–20 m long, twin-headed (est., Hideous Zippleback × Snow Wraith)', weight: '≈ 1,500–2,500 kg (est.)', behaviour: 'A bred hybrid combining the Hideous Zippleback\'s twin gas-and-spark heads with the Snow Wraith\'s heat-sensing hunt in icy terrain.', appears: 'Dragons: Titan Uprising (mobile game)' },
  ];
